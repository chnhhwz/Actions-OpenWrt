...
# 修改版本信息
sed -i "s/OpenWrt /Duck Bobby $(TZ=UTC-8 date "+%Y") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings

# 修改主机名
sed -i 's/OpenWrt/WangZ-Route/g' package/base-files/files/bin/config_generate
